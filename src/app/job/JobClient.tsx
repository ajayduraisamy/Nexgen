        ...
        <section className="t-[112px] sm:pt-[112px] md:pt-[120px] lg:pt-[128px] bg-white py-20 px-4 md:px-10 font-[Mooli] text-[#1c2e4a]">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="flex flex-col justify-between">
                    <div>
                        <h2 className="text-5xl font-extrabold text-[#1c2e4a] mb-6">Get in Touch</h2>
                        ...
                        <div className="space-y-5">
                            <div className="flex items-center gap-4 text-gray-800 text-lg">
                                ...
                                DR NEXGEN Technologies, Vijayanagar, Bangalore
                            </div>
                            <div className="flex items-center gap-4 text-gray-800 text-lg">
                ...
                <div className="bg-white p-10 shadow-2xl rounded-2xl border border-gray-200">
                    <h3 className="text-4xl font-bold mb-8 text-center text-[#1c2e4a]">Contact Form</h3>
